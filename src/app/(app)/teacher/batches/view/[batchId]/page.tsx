...
import { Eye, Loader2, CalendarDays, Clock, HomeIcon, Users, ArrowLeft } from "lucide-react";
        ...
        const fetchBatchDetails = async () => {
            ...
            try {
                ...
                if (!batchRes.ok) {
                    ...
                    router.push('/teacher/my-assigned-batches');
                    return;
                }
                ...
                setBatchDetails({ ...batchData, students: studentsInBatch });
    ...
    if (!batchDetails) {
        return (
            <div className="space-y-8">
                ...
                <Card>
                    <CardContent>
                        <p>The batch details could not be loaded. It might have been deleted or you may not have access.</p>
                        <Button onClick={() => router.push('/teacher/my-assigned-batches')} className="mt-4">Back to My Batches</Button>
                    </CardContent>
                </Card>
            </div>
        );
    ...
    return (
        <div className="space-y-8">
            <PageHeader
                ...
                description={`Details for the batch: ${batchDetails.topic}`}
                icon={Eye}
                actions={

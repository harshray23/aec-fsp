  ...
  if (isLoading) {
    return (
      <div className="space-y-8">
        <PageHeader title="Timetable Overview (Admin)" icon={CalendarDays} />
        ...
        <CardContent>
          {processedTimetables.length > 0 ? (
            <Accordion type="single" collapsible className="w-full">
             ...
             <p className="text-center text-muted-foreground py-4">No batches with schedules found in the system. Configure batches to see them here.</p>
          )}
        </CardContent>
      </Card>
    </div>
